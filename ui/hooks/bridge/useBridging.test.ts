...
describe('useBridging', () => {
  ...
  describe('extensionSupport=false, chainId=1', () => {
    ...
    it.each([
      [
        'https://portfolio.test/bridge?metamaskEntry=ext_bridge_button&metametricsId=0xtestMetaMetricsId&token=0x0000000000000000000000000000000000000000',
        ETH_SWAPS_TOKEN_OBJECT,
        'Home',
        undefined,
      ],
      [
        'https://portfolio.test/bridge?metamaskEntry=ext_bridge_button&metametricsId=0xtestMetaMetricsId&token=native',
        ETH_SWAPS_TOKEN_OBJECT,
        MetaMetricsSwapsEventSource.TokenView,
        '&token=native',
      ],
      [
        'https://portfolio.test/bridge?metamaskEntry=ext_bridge_button&metametricsId=0xtestMetaMetricsId&token=0x00232f2jksdauo',
        {
